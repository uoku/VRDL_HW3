...
cfg.MODEL.RPN.POST_NMS_TOPK_TEST = 50000

# path to the model we just trained
cfg.MODEL.WEIGHTS = os.path.join("./output_nucleus_v8", "model_final.pth")
cfg.MODEL.ROI_HEADS.SCORE_THRESH_TEST = 0.72   # set a custom testing threshold
